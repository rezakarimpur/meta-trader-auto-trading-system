...
from trading_strategies.mlstrategy.Lstm_strategy import LSTM
#from trading_strategies.price_action import Price_action
#from trading_strategies.mlstrategy.classifer_strategy import ML
...
class DecisionMaker:
    ...
    def predict(self, history):
        ...
        signal_lst, df = strategy.run_ML()
        #signal_lst, df = strategy.run_price_action()
